...
class Investee extends Component<{}> {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    sendRequest = () =>
  {
     const {amount,username,duration,area,rate,date,negotiation} = this.state;

    //Alert.alert('before submit', `${name}`);
      

    var data ={"uname":username,"amount":amount,"area":area,"duration":duration,"rate":rate,"negotiation":negotiation,"date":date}

   fetch('http://192.168.8.103:8080/api/auth/userdreq', {
    method: 'POST',
    headers: {
		 ...
		 //style={{
		  //width:300, height:300 , 
            ...
            <TextInput style={styles.ModalinputBox}
			 ...
			 <TouchableOpacity onPress={() =>  this.props.navigation.navigate('AllUserdReq',{username:this.state.username}) }>
                    <Text style={styles.buttonText}>View All the investee  Requests</Text>
                </TouchableOpacity>
			</ImageBackground>
			 ...
			 <TouchableOpacity   onPress={() => this.props.navigation.navigate('seeUserdReq',{username:this.state.username})}>
			 ...
			 <TouchableOpacity onPress={() => this.props.navigation.navigate('ItorReqDetailsforItee',{username:this.state.username})}>
			 ...
			 <TouchableOpacity onPress={() => this.props.navigation.navigate('AcceptedReqbyItee',{username:this.state.username})}>
