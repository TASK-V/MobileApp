...
export default class gettingAlluseraEx extends Component {
    ...
    loadData() {
        const url = 'http://192.168.8.103:8080/api/auth/usera'
        fetch(url, {
                method: 'GET',
                headers: {
...
/*
    getToken = async () => {
      ...
      */
       ...
       var url = 'http://192.168.8.103:8080/api/auth/usera/'
       //console.warn(id)
