...
export default class Lawyer extends Component {
    ...
    loadData() {
       // //console.warn("this is inside the load function ")
        ...
        const url = 'http://192.168.8.103:8080/api/auth/getlawyer'
        fetch(url, {
                method: 'GET',
                headers: {
                    ...
                    <View style={styles.container}>
                      ...
                      <CardItem  style={styles.cardItemStyle} >
                        <Left>
                          ...
                          <Text style={{color:'#4824F6'}}>Lawyer ID:</Text>
                      ...
                      <CardItem  style={styles.cardItemStyle} >
                        <Left>
                          <Body>
                            ...
                            <Text style={{color:'#4824F6'}}>Lawyer Name:</Text> 
                      ...
                      <CardItem  style={styles.cardItemStyle} >
                        <Left>
                          <Body>
                            ...
                            <Text style={{color:'#4824F6'}}>Lawyer email:</Text> 
