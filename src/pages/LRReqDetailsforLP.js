...
export default class LRReqDetailsforLP extends Component {
    ...
    static navigationOptions = {
      ...
      constructor(props) {
        ...
        this.state = {
          ...
          numOfNotifications:'',
          test:'ssss',
          userausername:this.props.navigation.state.params.username,
         loanreceiveruname:'',
         sum:0,
    ...
    loadData() {
       // //console.warn("this is inside the load function ")
        ...
        const url = 'http://192.168.8.103:8080/api/auth/getuserbreq'
        fetch(url, {
                method: 'GET',
                headers: {
...
toggleModal2 = () => {
 ...
 stuatusput = (id,uname,nego) => {
   ...
   var data ={"reqid":uid,"runame":userausername,"suname":uname, "receiverstatus":"Accepted","senderstatus":nego,"lawyer":"notyest","comments": "commentNo"}
  fetch('http://192.168.8.103:8080/api/auth/userbreqstatus', {
    method: 'POST',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
