...
export default class seeAllUserdReq extends Component {
    ...
    loadData() {
        ...
        const url = 'http://192.168.8.103:8080/api/auth/getuserdreq/uname/' + this.state.userdusername
        fetch(url, {
                method: 'GET',
                headers: {
    ...
    var url = 'http://192.168.8.103:8080/api/auth/userdreq/delete/'
