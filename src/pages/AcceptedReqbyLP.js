...
export default class AcceptedReqbyLP extends Component {

    static navigationOptions = {
        title: 'Accepted Requests as a Loan Provider',
        headerStyle: {
    ...
    loadData() {
        ...
        const url =  'http://192.168.8.103:8080/api/auth/getuserbreqstatus/runame/'+ this.state.userausername +'/status/Accepted'
        fetch(url, {
                method: 'GET',
                headers: {
                      ...
                      <CardItem  style={styles.cardItemStyle} >
                        <Left>
                          ...
                          <Text style={{color:'#4824F6'}}>Loan Provider name:</Text>
                            ...
                            <Text style={{color:'#4824F6'}}>Sender's Status:</Text> 
