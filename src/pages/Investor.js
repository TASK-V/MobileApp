...
class Investor extends Component<{}> {
    ...
    sendRequest = () =>
  {
   ...
   fetch('http://192.168.8.103:8080/api/auth/usercreq', {
    method: 'POST',
    headers: {
...
<TouchableOpacity style={styles.ModalButton} onPress={this.sendRequest.bind(this)}>
			 ...
			 <TouchableOpacity  onPress={this.toggleModal}>
                    <Text style={styles.buttonText}>Send New Requests to Investee</Text>
                </TouchableOpacity>
			</ImageBackground>
			 ...
			 <TouchableOpacity  onPress={() =>  this.props.navigation.navigate('AllUsercReq',{username:this.state.username}) }>
                    <Text style={styles.buttonText}>View All others investor's Requests</Text>
                </TouchableOpacity>
			</ImageBackground>
			 ...
			 <TouchableOpacity   onPress={() => this.props.navigation.navigate('seeUsercReq',{username:this.state.username})}>
			 ...
			 <TouchableOpacity  onPress={() => this.props.navigation.navigate('IteeReqDetailsforItor',{username:this.state.username})}>
                    <Text style={styles.buttonText}>View investees  Requests</Text>
                </TouchableOpacity>
			</ImageBackground>
			 ...
			 <TouchableOpacity  onPress={() => this.props.navigation.navigate('AcceptedReqbyItor',{username:this.state.username})}>
