...
export default class gettingAllusercEx extends Component {
    ...
    loadData() {
        const url = 'http://192.168.8.103:8080/api/auth/userc'
        fetch(url, {
                method: 'GET',
                headers: {
...
/*
    getToken = async () => {
      ...
      */
       ...
       var url = 'http://192.168.8.103:8080/api/auth/userc/'
