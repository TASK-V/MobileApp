...
export default class seeAllUseraReq extends Component {

    static navigationOptions = {
        title: 'Loan Provider\' details',
        headerStyle: {
    ...
    loadData() {
        ...
        const url = 'http://192.168.8.103:8080/api/auth/getuserareq/uname/' + this.state.userausername
        fetch(url, {
                method: 'GET',
                headers: {
    ...
    var url = 'http://192.168.8.103:8080/api/auth/userareq/delete/'
