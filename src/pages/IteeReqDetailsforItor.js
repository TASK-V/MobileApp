...
export default class IteeReqDetailsforItor extends Component {

    static navigationOptions = {
        title: 'Investee\'s Request details',
        headerStyle: {
    ...
    loadData() {
       // //console.warn("this is inside the load function ")
        ...
        const url = 'http://192.168.8.103:8080/api/auth/getuserdreq'
        fetch(url, {
                method: 'GET',
                headers: {
...
toggleModal2 = () => {
 ...
 stuatusput = (id,uname,nego) => {
    ...
    const {usercusername} = this.state;
...
//suname - LP, runame - LR
   ...
   var data ={"reqid":uid,"runame":usercusername,"suname":uname, "receiverstatus":"Accepted","senderstatus":nego,"lawyer":"notyest","comments": "commentNo"}
  fetch('http://192.168.8.103:8080/api/auth/userdreqstatus', {
    method: 'POST',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
