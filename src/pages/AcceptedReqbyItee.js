...
export default class AcceptedReqbyItee extends Component {

    static navigationOptions = {
        title: 'Accepted Requests as a investee',
        headerStyle: {
    ...
    loadData() {
        ...
        const url =  'http://192.168.8.103:8080/api/auth/getusercreqstatus/runame/'+ this.state.userdusername +'/status/Accepted'
        fetch(url, {
                method: 'GET',
                headers: {
