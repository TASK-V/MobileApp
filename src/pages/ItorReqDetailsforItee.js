...
export default class ItorReqDetailsforItee extends Component {

    static navigationOptions = {
        title: 'Investor \'s Requests',
        headerStyle: {
      ...
      constructor(props) {
        ...
        this.state = {
          ...
          numOfNotifications:'',
          test:'ssss',
          userdusername:this.props.navigation.state.params.username,
    ...
    loadData() {
       // //console.warn("this is inside the load function ")
        ...
        const url = 'http://192.168.8.103:8080/api/auth/getusercreq'
        fetch(url, {
                method: 'GET',
                headers: {
...
toggleModal2 = () => {
 ...
 stuatusput = (id,uname,nego) => {
    ...
    const {userdusername} = this.state;
...
//suname - LP, runame - LR
   ...
   var data ={"reqid":uid,"runame":userdusername,"suname":uname, "receiverstatus":"Accepted","senderstatus":nego,"lawyer":"notyest","comments": "commentNo"}
  fetch('http://192.168.8.103:8080/api/auth/usercreqstatus', {
    method: 'POST',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
   ...
   .then((res)=>{
			...
			//  this.props.navigation.navigate('login');
				     alert("status is working thanusan wa nathi karoo")
