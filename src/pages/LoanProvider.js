...
class LoanProvider extends Component<{}> {
    ...
    sendRequest = () =>
  {
   ...
   fetch('http://192.168.8.103:8080/api/auth/userareq', {
    method: 'POST',
    headers: {
...
<TouchableOpacity style={styles.ModalButton} onPress={this.sendRequest.bind(this)}>
			 ...
			 <TouchableOpacity  onPress={this.toggleModal}>
                    <Text style={styles.buttonText}>Send New Requests to Loan Receiver</Text>
                </TouchableOpacity>
			</ImageBackground>
       ...
       <TouchableOpacity  
       onPress={() =>  this.props.navigation.navigate('AllUseraReq',{username:this.state.username}) }
       >
                    <Text style={styles.buttonText}>View other Loan Providers Requests</Text>
                </TouchableOpacity>
			</ImageBackground>
       ...
       <TouchableOpacity   
       onPress={() => this.props.navigation.navigate('seeUseraReq',{username:this.state.username})}
       >
       ...
       <TouchableOpacity 
        onPress={() => this.props.navigation.navigate('LRReqDetailsforLP',{username:this.state.username})}
        >
                    <Text style={styles.buttonText}>View Loan Receiver  Requests</Text>
                </TouchableOpacity>
			</ImageBackground>
			 ...
			 <TouchableOpacity  onPress={() => this.props.navigation.navigate('AcceptedReqbyLP',{username:this.state.username})}>
