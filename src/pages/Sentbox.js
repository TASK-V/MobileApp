...
export default class Sentbox extends Component {
    ...
    loadData() {
       ...
       const {username} = this.state;
        ...
        const url = 'http://192.168.8.103:8080/api/auth/usermess/fromuname/' + username
        fetch(url, {
                method: 'GET',
                headers: {
                    ...
                    <View style={styles.container}>
                      ...
                      <CardItem  style={styles.cardItemStyle} >
                        <Left>
                          ...
                          <Text style={{color:'#4824F6'}}>message ID:</Text>
                            <Text style={{color:'black'}}>{item.id}</Text> 
                            <Text style={{color:'#4824F6'}}>from:</Text>
                            <Text style={{color:'black'}}>{item.fromuname}</Text> 
                            <Text style={{color:'#4824F6'}}>To:</Text>
                            <Text style={{color:'black'}}>{item.touname}</Text> 
                            <Text style={{color:'#4824F6'}}>date:</Text>
                            <Text style={{color:'black'}}>{item.date}</Text> 
                            <Text  style={{color:'#4824F6'}}>Message:</Text>
                            <Text  style={{color:'#4824F6'}}>{item.name}</Text>
