...
export default class gettingAlluserdEx extends Component {
    ...
    loadData() {
        const url = 'http://192.168.8.103:8080/api/auth/userd'
        fetch(url, {
                method: 'GET',
                headers: {
...
/*
    getToken = async () => {
      ...
      */
       ...
       var url = 'http://192.168.8.103:8080/api/auth/userd/'
